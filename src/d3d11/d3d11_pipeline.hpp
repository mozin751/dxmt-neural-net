...
CreateGraphicsPipeline(MTLD3D11Device *pDevice, MTL_GRAPHICS_PIPELINE_DESC *pDesc, std::unordered_map<size_t, WMT::Reference<WMT::BinaryArchive>>& pso_cache, std::mutex& pso_cache_mutex);
