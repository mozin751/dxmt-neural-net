...
CreateGraphicsPipeline(MTLD3D11Device *pDevice, MTL_GRAPHICS_PIPELINE_DESC *pDesc, std::unordered_map<size_t, uint32_t>& pso_cache, std::vector<WMT::Reference<WMT::BinaryArchive>>& bin_archives);
